...
<div style={{maxWidth: '650px', margin: '0px auto'}}>
    ...
    URI for Security Analytics Cash Flows are formatted as follows:

    ```
    https://api.finx.io?method=[method_name]&security_id=[security_identifier]&as_of_date=[as_of_date]&price=[price]&shock=[None]
    ```
